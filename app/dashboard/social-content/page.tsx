...
const PREVIEW_IMAGES = [
  { src: getPreviewImage("socialContent"), alt: "Social" },
  { src: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=400&q=80", alt: "Content" },
  { src: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=400&q=80", alt: "Media" },
];
...
export default function SocialContentPage() {
  ...
  const suggestions = getSuggestionsForFactory("socialContent");
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/api/factory/run", {
        ...
        body: JSON.stringify({ factoryId: "socialContent", prompt: prompt.trim() }),
      });
    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <p className="text-slate-400 mb-8">
          Generate social media content packs: post ideas, captions, hashtags, and content calendar.
        </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 mb-8">
          ...
          <div>
            <Label className="text-slate-400">Topic or platform</Label>
            <Input
              value={prompt}
              onChange={(e) => setPrompt(e.target.value)}
              placeholder="e.g. Instagram content pack, 7 posts"
        ...
        {!loading && result != null && (
          ...
          >
            ...
            <ResultToolbar
              factoryId="socialContent"
              factoryName="AI Social Content Factory"
              prompt={prompt}
              resultData={result}
