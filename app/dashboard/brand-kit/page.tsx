...
const PREVIEW_IMAGES = [
  { src: getPreviewImage("brandKit"), alt: "Brand" },
...
export default function BrandKitPage() {
  ...
  const suggestions = getSuggestionsForFactory("brandKit");
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/api/factory/run", {
        ...
        body: JSON.stringify({ factoryId: "brandKit", prompt: prompt.trim() }),
      });
    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <h1 className="text-3xl font-bold text-white mb-2 flex items-center gap-3">
          ...
          AI Brand Kit Factory
        </h1>
        <p className="text-slate-400 mb-8">
          Generate full brand identity: logo ideas, colors, typography, and social media style.
        </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 mb-8">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Tech startup, modern, minimal"
        ...
        {!loading && result != null && (
          ...
          >
            ...
            <ResultToolbar
              factoryId="brandKit"
              factoryName="AI Brand Kit Factory"
              prompt={prompt}
              resultData={result}
