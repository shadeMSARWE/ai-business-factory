...
function groupByCategory(
...
): Record<FactoryCategory, FactoryConfig[]> {
  ...
  factories.forEach((factory) => {
    const category = factory.category || "core";
    groups[category].push(factory);
  });
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/builder">
            <Button
              size="lg"
              className="h-12 px-8 text-lg bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600"
            >
              {t("create_website")}
            </Button>
          </Link>
