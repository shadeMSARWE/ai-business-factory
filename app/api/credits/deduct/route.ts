...
const VALID_ACTIONS: CreditAction[] = ["website", "logo", "seo", "ads", "businessFinderSearch", "businessWebsite", "autoOutreachSearch", "autoOutreachGenerate", "autoOutreachMessage", "autoOutreachSend"];
