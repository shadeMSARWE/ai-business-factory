...
export const FACTORY_ENGINE_REGISTRY: Record<string, Omit<FactoryEngineConfig, "id">> = {
  ...
  saasBuilder: {
    ...
    description: "Generate full SaaS concept.",
    category: "core",
    icon: "box",
    engine: "text",
    prompts: "text",
  ...
  marketingStrategy: {
    ...
    description: "Generate complete marketing strategies.",
    category: "growth",
    icon: "megaphone",
    engine: "text",
    prompts: "text",
  ...
  productGenerator: {
    ...
    description: "Create product ideas for ecommerce.",
    category: "core",
    icon: "store",
    engine: "text",
    prompts: "text",
  ...
  startupValidator: {
    ...
    description: "Analyze startup ideas.",
    category: "growth",
    icon: "search",
    engine: "text",
    prompts: "text",
  ...
  contentCalendar: {
    ...
    description: "Generate social content calendars.",
    category: "growth",
    icon: "calendar",
    engine: "text",
    prompts: "text",
  ...
  businessPlan: {
    ...
    description: "Create complete business plans.",
    category: "core",
    icon: "file-text",
    engine: "text",
    prompts: "text",
  ...
  funnelBuilder: {
    ...
    description: "Generate marketing funnels.",
    category: "growth",
    icon: "layout",
    engine: "text",
    prompts: "text",
